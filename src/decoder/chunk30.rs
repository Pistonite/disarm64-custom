                                        ...
                                        if insn & 0x80000000 == 0 {
                                            if insn & 0x40000000 == 0 {
                                                if insn & 0xffe00c00 == 0x38400800 {
                                                    return Some(LDTRB_Rt_ADDR_SIMM9::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            } else {
                                                if insn & 0xffe00c00 == 0x78400800 {
                                                    return Some(LDTRH_Rt_ADDR_SIMM9::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            }
                                            ...
                                            if insn & 0xbfe00c00 == 0xb8400800 {
                                                return Some(LDTR_Rt_ADDR_SIMM9::make_opcode(insn));
                                            }
                                        }
                                    }
                                } else {
                                        ...
                                        if insn & 0x80000000 == 0 {
                                            if insn & 0x40000000 == 0 {
                                                if insn & 0xffe00c00 == 0x38200800 {
                                                    return Some(STRB_Rt_ADDR_REGOFF::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            } else {
                                                if insn & 0xffe00c00 == 0x78200800 {
                                                    return Some(STRH_Rt_ADDR_REGOFF::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            }
                                            ...
                                            if insn & 0xbfe00c00 == 0xb8200800 {
                                                return Some(STR_Rt_ADDR_REGOFF::make_opcode(insn));
                                            }
                                        }
                                    } else {
                                        if insn & 0x80000000 == 0 {
                                            if insn & 0x40000000 == 0 {
                                                if insn & 0xffe00c00 == 0x38600800 {
                                                    return Some(LDRB_Rt_ADDR_REGOFF::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            } else {
                                                if insn & 0xffe00c00 == 0x78600800 {
                                                    return Some(LDRH_Rt_ADDR_REGOFF::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            }
                                            ...
                                            if insn & 0xbfe00c00 == 0xb8600800 {
                                                return Some(LDR_Rt_ADDR_REGOFF::make_opcode(insn));
                                            }
                                        }
                                    }
                                }
                                    ...
                                    if insn & 0x80000000 == 0 {
                                        if insn & 0x40000000 == 0 {
                                            if insn & 0xffe00400 == 0x38000400 {
                                                return Some(STRB_Rt_ADDR_SIMM9::make_opcode(insn));
                                            }
                                        } else {
                                            if insn & 0xffe00400 == 0x78000400 {
                                                return Some(STRH_Rt_ADDR_SIMM9::make_opcode(insn));
                                            }
                                        }
                                    } else {
                                    ...
                                    if insn & 0x80000000 == 0 {
                                        if insn & 0x40000000 == 0 {
                                            if insn & 0xffe00400 == 0x38400400 {
                                                return Some(LDRB_Rt_ADDR_SIMM9::make_opcode(insn));
                                            }
                                        } else {
                                            if insn & 0xffe00400 == 0x78400400 {
                                                return Some(LDRH_Rt_ADDR_SIMM9::make_opcode(insn));
                                            }
                                        }
                                    } else {
                                    ...
                                    if insn & 0x40000000 == 0 {
                                        if insn & 0x80000000 == 0 {
                                            if insn & 0xffa00c00 == 0x38800000 {
                                                return Some(LDURSB_Rt_ADDR_SIMM9::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        } else {
                                            if insn & 0xffe00c00 == 0xb8800000 {
                                                return Some(LDURSW_Rt_ADDR_SIMM9::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        }
                                        ...
                                        if insn & 0x80000000 == 0 {
                                            ...
                                            if insn & 0xffe00c00 == 0xf8800000 {
                                                return Some(PRFUM_PRFOP_ADDR_SIMM9::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        }
                            ...
                            if insn & 0x000400 == 0 {
                                if insn & 0x000800 == 0 {
                                    if insn & 0x400000 == 0 {
                                        ...
                                        if insn & 0x40000000 == 0 {
                                            if insn & 0x7fe00c10 == 0x3a400000 {
                                                return Some(CCMN_Rn_Rm_NZCV_COND::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        } else {
                                            if insn & 0x7fe00c10 == 0x7a400000 {
                                                return Some(CCMP_Rn_Rm_NZCV_COND::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        }
                                    ...
                                    if insn & 0x40000000 == 0 {
                                        if insn & 0x7fe00c10 == 0x3a400800 {
                                            return Some(CCMN_Rn_CCMP_IMM_NZCV_COND::make_opcode(
                                                insn,
                                            ));
                                        }
                                    } else {
                                        if insn & 0x7fe00c10 == 0x7a400800 {
                                            return Some(CCMP_Rn_CCMP_IMM_NZCV_COND::make_opcode(
                                                insn,
                                            ));
                                        }
                                    }
                                ...
                                if insn & 0x40000000 == 0 {
                                    if insn & 0x7fe00c00 == 0x1a800400 {
                                        return Some(CSINC_Rd_Rn_Rm_COND::make_opcode(insn));
                                    }
                                } else {
                                    if insn & 0x7fe00c00 == 0x5a800400 {
                                        return Some(CSNEG_Rd_Rn_Rm_COND::make_opcode(insn));
                                    }
                                }
                            }
                        }
