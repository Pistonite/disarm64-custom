...
impl InsnOpcode for FLOATDP1 {
    fn definition(&self) -> &'static Insn {
        match self {
            FLOATDP1::FABS_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FABS_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
            ...
            FLOATDP1::FNEG_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FNEG_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
            FLOATDP1::FRINT32X_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINT32Z_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINT64X_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINT64Z_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINTA_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINTA_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
            FLOATDP1::FRINTI_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINTI_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
            FLOATDP1::FRINTM_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINTM_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
            FLOATDP1::FRINTN_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINTN_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
            FLOATDP1::FRINTP_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINTP_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
            FLOATDP1::FRINTX_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINTX_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
            FLOATDP1::FRINTZ_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FRINTZ_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
            FLOATDP1::FSQRT_Fd_Fn(opcode) => opcode.definition(),
            FLOATDP1::FSQRT_Fd_S_S_Fn_S_S(opcode) => opcode.definition(),
        }
    }
    fn bits(&self) -> u32 {
        match self {
            FLOATDP1::FABS_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FABS_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
            ...
            FLOATDP1::FNEG_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FNEG_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
            FLOATDP1::FRINT32X_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINT32Z_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINT64X_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINT64Z_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINTA_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINTA_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
            FLOATDP1::FRINTI_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINTI_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
            FLOATDP1::FRINTM_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINTM_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
            FLOATDP1::FRINTN_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINTN_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
            FLOATDP1::FRINTP_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINTP_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
            FLOATDP1::FRINTX_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINTX_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
            FLOATDP1::FRINTZ_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FRINTZ_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
            FLOATDP1::FSQRT_Fd_Fn(opcode) => opcode.bits(),
            FLOATDP1::FSQRT_Fd_S_S_Fn_S_S(opcode) => opcode.bits(),
        }
    }
}
