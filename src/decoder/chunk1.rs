...
#[bitfield(u32)]
#[derive(PartialEq, Eq)]
pub struct FMADD_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S {
    #[bits(5)]
    pub rd: u32,
    #[bits(5)]
    pub rn: u32,
...
#[bitfield(u32)]
#[derive(PartialEq, Eq)]
pub struct FMAX_Fd_S_S_Fn_S_S_Fm_S_S {
    #[bits(5)]
    pub rd: u32,
    #[bits(5)]
    pub rn: u32,
...
#[bitfield(u32)]
#[derive(PartialEq, Eq)]
pub struct FMAXNM_Fd_S_S_Fn_S_S_Fm_S_S {
    #[bits(5)]
    pub rd: u32,
    #[bits(5)]
    pub rn: u32,
...
#[bitfield(u32)]
#[derive(PartialEq, Eq)]
pub struct FMIN_Fd_S_S_Fn_S_S_Fm_S_S {
    #[bits(5)]
    pub rd: u32,
    #[bits(5)]
    pub rn: u32,
...
#[bitfield(u32)]
#[derive(PartialEq, Eq)]
pub struct FMINNM_Fd_S_S_Fn_S_S_Fm_S_S {
    #[bits(5)]
    pub rd: u32,
    #[bits(5)]
    pub rn: u32,
