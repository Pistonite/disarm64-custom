...
use super::*;
impl InsnOpcode for FMADD_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S {
...
impl FMAX_Fd_Fn_Fm {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fmax,
            operation: Operation::FLOATDP2(FLOATDP2::FMAX_Fd_Fn_Fm(FMAX_Fd_Fn_Fm::from(bits))),
        }
    }
}
...
impl FMAX_Fd_S_S_Fn_S_S_Fm_S_S {
    pub const DEFINITION: Insn = Insn {
        mnemonic: "fmax",
        aliases: &[],
        opcode: 0x1e204800,
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fmax,
            operation: Operation::FLOATDP2(FLOATDP2::FMAX_Fd_S_S_Fn_S_S_Fm_S_S(
                FMAX_Fd_S_S_Fn_S_S_Fm_S_S::from(bits),
            )),
        }
    }
}
impl InsnOpcode for FMAX_Fd_S_S_Fn_S_S_Fm_S_S {
    fn definition(&self) -> &'static Insn {
        &Self::DEFINITION
    }
    fn bits(&self) -> u32 {
...
impl FMAXNM_Fd_Fn_Fm {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fmaxnm,
            operation: Operation::FLOATDP2(FLOATDP2::FMAXNM_Fd_Fn_Fm(FMAXNM_Fd_Fn_Fm::from(bits))),
        }
    }
}
...
impl FMAXNM_Fd_S_S_Fn_S_S_Fm_S_S {
    pub const DEFINITION: Insn = Insn {
        mnemonic: "fmaxnm",
        aliases: &[],
        opcode: 0x1e206800,
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fmaxnm,
            operation: Operation::FLOATDP2(FLOATDP2::FMAXNM_Fd_S_S_Fn_S_S_Fm_S_S(
                FMAXNM_Fd_S_S_Fn_S_S_Fm_S_S::from(bits),
            )),
        }
    }
}
impl InsnOpcode for FMAXNM_Fd_S_S_Fn_S_S_Fm_S_S {
    fn definition(&self) -> &'static Insn {
        &Self::DEFINITION
    }
    fn bits(&self) -> u32 {
...
impl FMIN_Fd_Fn_Fm {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fmin,
            operation: Operation::FLOATDP2(FLOATDP2::FMIN_Fd_Fn_Fm(FMIN_Fd_Fn_Fm::from(bits))),
        }
    }
}
...
impl FMIN_Fd_S_S_Fn_S_S_Fm_S_S {
    pub const DEFINITION: Insn = Insn {
        mnemonic: "fmin",
        aliases: &[],
        opcode: 0x1e205800,
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fmin,
            operation: Operation::FLOATDP2(FLOATDP2::FMIN_Fd_S_S_Fn_S_S_Fm_S_S(
                FMIN_Fd_S_S_Fn_S_S_Fm_S_S::from(bits),
            )),
        }
    }
}
impl InsnOpcode for FMIN_Fd_S_S_Fn_S_S_Fm_S_S {
    fn definition(&self) -> &'static Insn {
        &Self::DEFINITION
    }
    fn bits(&self) -> u32 {
...
impl FMINNM_Fd_Fn_Fm {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fminnm,
            operation: Operation::FLOATDP2(FLOATDP2::FMINNM_Fd_Fn_Fm(FMINNM_Fd_Fn_Fm::from(bits))),
        }
    }
}
...
impl FMINNM_Fd_S_S_Fn_S_S_Fm_S_S {
    pub const DEFINITION: Insn = Insn {
        mnemonic: "fminnm",
        aliases: &[],
        opcode: 0x1e207800,
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fminnm,
            operation: Operation::FLOATDP2(FLOATDP2::FMINNM_Fd_S_S_Fn_S_S_Fm_S_S(
                FMINNM_Fd_S_S_Fn_S_S_Fm_S_S::from(bits),
            )),
        }
    }
}
impl InsnOpcode for FMINNM_Fd_S_S_Fn_S_S_Fm_S_S {
    fn definition(&self) -> &'static Insn {
        &Self::DEFINITION
    }
    fn bits(&self) -> u32 {
