...
impl FCVTX_SVE_Zd_SVE_Pg3_SVE_Zn {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fcvtx,
            operation: Operation::SVE_MISC(SVE_MISC::FCVTX_SVE_Zd_SVE_Pg3_SVE_Zn(
                FCVTX_SVE_Zd_SVE_Pg3_SVE_Zn::from(bits),
            )),
        }
    }
}
...
impl FCVTXNT_SVE_Zd_SVE_Pg3_SVE_Zn {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fcvtxnt,
            operation: Operation::SVE_MISC(SVE_MISC::FCVTXNT_SVE_Zd_SVE_Pg3_SVE_Zn(
                FCVTXNT_SVE_Zd_SVE_Pg3_SVE_Zn::from(bits),
            )),
        }
    }
}
