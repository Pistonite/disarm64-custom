...
impl FMINNMP_Sd_Vn {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fminnmp,
            operation: Operation::ASISDPAIR(ASISDPAIR::FMINNMP_Sd_Vn(FMINNMP_Sd_Vn::from(bits))),
        }
    }
}
...
impl FMINNMP_Sd_S_S_Vn_V_2S {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#fminnmp,
            operation: Operation::ASISDPAIR(ASISDPAIR::FMINNMP_Sd_S_S_Vn_V_2S(
                FMINNMP_Sd_S_S_Vn_V_2S::from(bits),
            )),
        }
    }
}
