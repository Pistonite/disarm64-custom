...
impl InsnOpcode for FLOATDP2 {
    fn definition(&self) -> &'static Insn {
        match self {
            ...
            FLOATDP2::FMAXNM_Fd_Fn_Fm(opcode) => opcode.definition(),
            FLOATDP2::FMAXNM_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.definition(),
            FLOATDP2::FMAX_Fd_Fn_Fm(opcode) => opcode.definition(),
            FLOATDP2::FMAX_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.definition(),
            FLOATDP2::FMINNM_Fd_Fn_Fm(opcode) => opcode.definition(),
            FLOATDP2::FMINNM_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.definition(),
            FLOATDP2::FMIN_Fd_Fn_Fm(opcode) => opcode.definition(),
            FLOATDP2::FMIN_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.definition(),
            FLOATDP2::FMUL_Fd_Fn_Fm(opcode) => opcode.definition(),
            FLOATDP2::FMUL_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.definition(),
            FLOATDP2::FNMUL_Fd_Fn_Fm(opcode) => opcode.definition(),
            FLOATDP2::FNMUL_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.definition(),
    ...
    fn bits(&self) -> u32 {
        match self {
            ...
            FLOATDP2::FMAXNM_Fd_Fn_Fm(opcode) => opcode.bits(),
            FLOATDP2::FMAXNM_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.bits(),
            FLOATDP2::FMAX_Fd_Fn_Fm(opcode) => opcode.bits(),
            FLOATDP2::FMAX_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.bits(),
            FLOATDP2::FMINNM_Fd_Fn_Fm(opcode) => opcode.bits(),
            FLOATDP2::FMINNM_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.bits(),
            FLOATDP2::FMIN_Fd_Fn_Fm(opcode) => opcode.bits(),
            FLOATDP2::FMIN_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.bits(),
            FLOATDP2::FMUL_Fd_Fn_Fm(opcode) => opcode.bits(),
            FLOATDP2::FMUL_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.bits(),
            FLOATDP2::FNMUL_Fd_Fn_Fm(opcode) => opcode.bits(),
            FLOATDP2::FNMUL_Fd_S_S_Fn_S_S_Fm_S_S(opcode) => opcode.bits(),
...
impl InsnOpcode for FLOATDP3 {
    fn definition(&self) -> &'static Insn {
        match self {
            FLOATDP3::FMADD_Fd_Fn_Fm_Fa(opcode) => opcode.definition(),
            FLOATDP3::FMADD_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S(opcode) => opcode.definition(),
            FLOATDP3::FMSUB_Fd_Fn_Fm_Fa(opcode) => opcode.definition(),
            FLOATDP3::FMSUB_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S(opcode) => opcode.definition(),
            FLOATDP3::FNMADD_Fd_Fn_Fm_Fa(opcode) => opcode.definition(),
            FLOATDP3::FNMADD_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S(opcode) => opcode.definition(),
            FLOATDP3::FNMSUB_Fd_Fn_Fm_Fa(opcode) => opcode.definition(),
            FLOATDP3::FNMSUB_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S(opcode) => opcode.definition(),
        }
    }
    fn bits(&self) -> u32 {
        match self {
            FLOATDP3::FMADD_Fd_Fn_Fm_Fa(opcode) => opcode.bits(),
            FLOATDP3::FMADD_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S(opcode) => opcode.bits(),
            FLOATDP3::FMSUB_Fd_Fn_Fm_Fa(opcode) => opcode.bits(),
            FLOATDP3::FMSUB_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S(opcode) => opcode.bits(),
            FLOATDP3::FNMADD_Fd_Fn_Fm_Fa(opcode) => opcode.bits(),
            FLOATDP3::FNMADD_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S(opcode) => opcode.bits(),
            FLOATDP3::FNMSUB_Fd_Fn_Fm_Fa(opcode) => opcode.bits(),
            FLOATDP3::FNMSUB_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S(opcode) => opcode.bits(),
        }
    }
}
                                                ...
                                                if insn & 0x020000 == 0 {
                                                            ...
                                                            if insn & 0x040000 == 0 {
                                                                if insn & 0x080000 == 0 {
                                                                    ...
                                                                    if insn & 0xff3ffc00
                                                                        == 0x1e204000
                                                                    {
                                                                        return Some (FMOV_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                    }
                                                                } else {
                                                                    if insn & 0xffbffc00
                                                                        == 0x1e284000
                                                                    {
                                                                        return Some (FRINT32Z_Fd_Fn :: make_opcode (insn)) ;
                                                                    }
                                                                }
                                                            } else {
                                                                if insn & 0xfffffc00 == 0x1ee44000 {
                                                                    return Some(
                                                                        FRINTN_Fd_Fn::make_opcode(
                                                                            insn,
                                                                        ),
                                                                    );
                                                                }
                                                                if insn & 0xff3ffc00 == 0x1e244000 {
                                                                    return Some (FRINTN_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                }
                                                            }
                                                        } else {
                                                            if insn & 0x040000 == 0 {
                                                                if insn & 0x080000 == 0 {
                                                                    ...
                                                                    if insn & 0xff3ffc00
                                                                        == 0x1e214000
                                                                    {
                                                                        return Some (FNEG_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                    }
                                                                } else {
                                                                    if insn & 0xffbffc00
                                                                        == 0x1e294000
                                                                    {
                                                                        return Some (FRINT64Z_Fd_Fn :: make_opcode (insn)) ;
                                                                    }
                                                                }
                                                            } else {
                                                                if insn & 0xfffffc00 == 0x1ee54000 {
                                                                    return Some(
                                                                        FRINTM_Fd_Fn::make_opcode(
                                                                            insn,
                                                                        ),
                                                                    );
                                                                }
                                                                if insn & 0xff3ffc00 == 0x1e254000 {
                                                                    return Some (FRINTM_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                }
                                                            }
                                                        }
                                                    } else {
                                                            ...
                                                            if insn & 0x040000 == 0 {
                                                                if insn & 0x080000 == 0 {
                                                                    ...
                                                                    if insn & 0xff3ffc00
                                                                        == 0x1e20c000
                                                                    {
                                                                        return Some (FABS_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                    }
                                                                } else {
                                                                    if insn & 0xffbffc00
                                                                        == 0x1e28c000
                                                                    {
                                                                        return Some (FRINT32X_Fd_Fn :: make_opcode (insn)) ;
                                                                    }
                                                                }
                                                            } else {
                                                                if insn & 0xfffffc00 == 0x1ee4c000 {
                                                                    return Some(
                                                                        FRINTP_Fd_Fn::make_opcode(
                                                                            insn,
                                                                        ),
                                                                    );
                                                                }
                                                                if insn & 0xff3ffc00 == 0x1e24c000 {
                                                                    return Some (FRINTP_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                }
                                                            }
                                                        } else {
                                                            if insn & 0x040000 == 0 {
                                                                if insn & 0x080000 == 0 {
                                                                    if insn & 0xfffffc00
                                                                        == 0x1ee1c000
                                                                    {
                                                                        return Some (FSQRT_Fd_Fn :: make_opcode (insn)) ;
                                                                    }
                                                                    if insn & 0xff3ffc00
                                                                        == 0x1e21c000
                                                                    {
                                                                        return Some (FSQRT_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                    }
                                                                } else {
                                                                    if insn & 0xffbffc00
                                                                        == 0x1e29c000
                                                                    {
                                                                        return Some (FRINT64X_Fd_Fn :: make_opcode (insn)) ;
                                                                    }
                                                                }
                                                            } else {
                                                                if insn & 0xfffffc00 == 0x1ee5c000 {
                                                                    return Some(
                                                                        FRINTZ_Fd_Fn::make_opcode(
                                                                            insn,
                                                                        ),
                                                                    );
                                                                }
                                                                if insn & 0xff3ffc00 == 0x1e25c000 {
                                                                    return Some (FRINTZ_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                }
                                                            }
                                                        }
                                                    }
                                                    ...
                                                    if insn & 0x040000 == 0 {
                                                        if insn & 0xff3e7c00 == 0x1e224000 {
                                                            return Some(FCVT_Fd_Fn::make_opcode(
                                                                insn,
                                                            ));
                                                        }
                                                    } else {
                                                        if insn & 0x008000 == 0 {
                                                            if insn & 0x010000 == 0 {
                                                                if insn & 0xfffffc00 == 0x1ee64000 {
                                                                    return Some(
                                                                        FRINTA_Fd_Fn::make_opcode(
                                                                            insn,
                                                                        ),
                                                                    );
                                                                }
                                                                if insn & 0xff3ffc00 == 0x1e264000 {
                                                                    return Some (FRINTA_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                }
                                                            } else {
                                                                if insn & 0xfffffc00 == 0x1ee74000 {
                                                                    return Some(
                                                                        FRINTX_Fd_Fn::make_opcode(
                                                                            insn,
                                                                        ),
                                                                    );
                                                                }
                                                                if insn & 0xff3ffc00 == 0x1e274000 {
                                                                    return Some (FRINTX_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                                }
                                                            }
                                                        } else {
                                                            if insn & 0xfffffc00 == 0x1ee7c000 {
                                                                return Some(
                                                                    FRINTI_Fd_Fn::make_opcode(insn),
                                                                );
                                                            }
                                                            if insn & 0xff3ffc00 == 0x1e27c000 {
                                                                return Some (FRINTI_Fd_S_S_Fn_S_S :: make_opcode (insn)) ;
                                                            }
                                                        }
                                                    }
                                                }
                                            ...
                                            if insn & 0x008000 == 0 {
                                                if insn & 0x10000000 == 0 {
                                                    ...
                                                    if insn & 0xffe0fc00 == 0x1ee00800 {
                                                        return Some(FMUL_Fd_Fn_Fm::make_opcode(
                                                            insn,
                                                        ));
                                                    }
                                                            ...
                                                            if insn & 0x800000 == 0 {
                                                                if insn & 0x20000000 == 0 {
                                                                    if insn & 0xbfbffc00
                                                                        == 0xe218800
                                                                    {
                                                                        return Some (FRINTN_Vd_Vn :: make_opcode (insn)) ;
                                                                    }
                                                                } else {
                                                                    if insn & 0xbfbffc00
                                                                        == 0x2e218800
                                                                    {
                                                                        return Some (FRINTA_Vd_Vn :: make_opcode (insn)) ;
                                                                    }
                                                                }
                                                            } else {
                                                                if insn & 0xbfbffc00 == 0xea18800 {
                                                                    return Some(
                                                                        FRINTP_Vd_Vn::make_opcode(
                                                                            insn,
                                                                        ),
                                                                    );
                                                                }
                                                    ...
                                                    if insn & 0x20000000 == 0 {
                                                        if insn & 0x40000000 == 0 {
                                                            if insn & 0xffe0fc00 == 0x1ee08800 {
                                                                return Some(
                                                                    FNMUL_Fd_Fn_Fm::make_opcode(
                                                                        insn,
                                                                    ),
                                                                );
                                                            }
                                                            if insn & 0xff20fc00 == 0x1e208800 {
                                                                return Some (FNMUL_Fd_S_S_Fn_S_S_Fm_S_S :: make_opcode (insn)) ;
                                                            }
                                                        } else {
                                                    ...
                                                    if insn & 0x010000 == 0 {
                                                        if insn & 0x20000000 == 0 {
                                                            if insn & 0xbf3ffc00 == 0xe204800 {
                                                                return Some(
                                                                    CLS_Vd_Vn::make_opcode(insn),
                                                                );
                                                            }
                                                        } else {
                                                            if insn & 0xbf3ffc00 == 0x2e204800 {
                                                                return Some(
                                                                    CLZ_Vd_Vn::make_opcode(insn),
                                                                );
                                                            }
                                                        }
                                                    } else {
                                                    ...
                                                    if insn & 0x20000000 == 0 {
                                                        if insn & 0x40000000 == 0 {
                                                            if insn & 0xffe0fc00 == 0x1ee04800 {
                                                                return Some(
                                                                    FMAX_Fd_Fn_Fm::make_opcode(
                                                                        insn,
                                                                    ),
                                                                );
                                                            }
                                                            if insn & 0xff20fc00 == 0x1e204800 {
                                                                return Some (FMAX_Fd_S_S_Fn_S_S_Fm_S_S :: make_opcode (insn)) ;
                                                            }
                                                        } else {
                                                        ...
                                                        if insn & 0xff3ffc00 == 0x7e214800 {
                                                            return Some(UQXTN_Sd_Sn::make_opcode(
                                                                insn,
                                                            ));
                                                        }
                                                    }
                                                ...
                                                if insn & 0x10000000 == 0 {
                                                    ...
                                                    if insn & 0x20000000 == 0 {
                                                        if insn & 0xffe0fc00 == 0x1ee02800 {
                                                            return Some(
                                                                FADD_Fd_Fn_Fm::make_opcode(insn),
                                                            );
                                                        }
                                                        if insn & 0xff20fc00 == 0x1e202800 {
                                                            return Some (FADD_Fd_S_S_Fn_S_S_Fm_S_S :: make_opcode (insn)) ;
                                                        }
                                                    } else {
                                                ...
                                                if insn & 0x10000000 == 0 {
                                                    ...
                                                    if insn & 0x20000000 == 0 {
                                                        if insn & 0xffe0fc00 == 0x1ee06800 {
                                                            return Some(
                                                                FMAXNM_Fd_Fn_Fm::make_opcode(insn),
                                                            );
                                                        }
                                                        if insn & 0xff20fc00 == 0x1e206800 {
                                                            return Some (FMAXNM_Fd_S_S_Fn_S_S_Fm_S_S :: make_opcode (insn)) ;
                                                        }
                                                    } else {
                                            ...
                                            if insn & 0x008000 == 0 {
                                                if insn & 0x10000000 == 0 {
                                                    if insn & 0xbf3ffc00 == 0xe201800 {
                                                        return Some(REV16_Vd_Vn::make_opcode(
                                                            insn,
                                                        ));
                                                    }
                                                } else {
                                                    if insn & 0xffe0fc00 == 0x1ee01800 {
                                                        return Some(FDIV_Fd_Fn_Fm::make_opcode(
                                                            insn,
                                                        ));
                                                    }
                                                ...
                                                if insn & 0x10000000 == 0 {
                                                    if insn & 0x20000000 == 0 {
                                                        if insn & 0xbf3ffc00 == 0xe205800 {
                                                            return Some(CNT_Vd_Vn::make_opcode(
                                                                insn,
                                                            ));
                                                        }
                                                    } else {
                                                        if insn & 0x400000 == 0 {
                                                            if insn & 0xbffffc00 == 0x2e205800 {
                                                                return Some(
                                                                    NOT_Vd_Vn::make_opcode(insn),
                                                                );
                                                            }
                                                        } else {
                                                            if insn & 0xbffffc00 == 0x2e605800 {
                                                                return Some(
                                                                    RBIT_Vd_Vn::make_opcode(insn),
                                                                );
                                                            }
                                                        }
                                                    }
                                                    ...
                                                    if insn & 0xffe0fc00 == 0x1ee05800 {
                                                        return Some(FMIN_Fd_Fn_Fm::make_opcode(
                                                            insn,
                                                        ));
                                                    }
                                                    if insn & 0xff20fc00 == 0x1e205800 {
                                                        return Some(
                                                            FMIN_Fd_S_S_Fn_S_S_Fm_S_S::make_opcode(
                                                                insn,
                                                            ),
                                                        );
                                                    }
                                                    ...
                                                    if insn & 0x010000 == 0 {
                                                        ...
                                                        if insn & 0x40000000 == 0 {
                                                            if insn & 0xff3ffc00 == 0x2e213800 {
                                                                return Some (SHLL_Vd_Vn_SHLL_IMM :: make_opcode (insn)) ;
                                                            }
                                                        } else {
                                                            if insn & 0xff3ffc00 == 0x6e213800 {
                                                                return Some (SHLL2_Vd_Vn_SHLL_IMM :: make_opcode (insn)) ;
                                                            }
                                                        }
                                                    }
                                                } else {
                                                    if insn & 0x20000000 == 0 {
                                                        if insn & 0x40000000 == 0 {
                                                            if insn & 0xffe0fc00 == 0x1ee03800 {
                                                                return Some(
                                                                    FSUB_Fd_Fn_Fm::make_opcode(
                                                                        insn,
                                                                    ),
                                                                );
                                                            }
                                                            if insn & 0xff20fc00 == 0x1e203800 {
                                                                return Some (FSUB_Fd_S_S_Fn_S_S_Fm_S_S :: make_opcode (insn)) ;
                                                            }
                                                        } else {
                                                            if insn & 0xff3ffc00 == 0x5e203800 {
                                                                return Some(
                                                                    SUQADD_Sd_Sn::make_opcode(insn),
                                                                );
                                                            }
                                                        }
                                                    } else {
                                                    ...
                                                    if insn & 0x20000000 == 0 {
                                                        if insn & 0x40000000 == 0 {
                                                            if insn & 0xffe0fc00 == 0x1ee07800 {
                                                                return Some(
                                                                    FMINNM_Fd_Fn_Fm::make_opcode(
                                                                        insn,
                                                                    ),
                                                                );
                                                            }
                                                            if insn & 0xff20fc00 == 0x1e207800 {
                                                                return Some (FMINNM_Fd_S_S_Fn_S_S_Fm_S_S :: make_opcode (insn)) ;
                                                            }
                                                        } else {
                                                        ...
                                                        if insn & 0xff3ffc00 == 0x7e207800 {
                                                            return Some(SQNEG_Sd_Sn::make_opcode(
                                                                insn,
                                                            ));
                                                        }
                                                    }
                                            ...
                                            if insn & 0x20000000 == 0 {
                                                if insn & 0x40000000 == 0 {
                                                    if insn & 0xffc0f400 == 0xf800000 {
                                                        return Some(
                                                            FMLAL_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                } else {
                                                    if insn & 0xffc0f400 == 0x4f800000 {
                                                        return Some (FMLAL_Vd_V_4S_Vn_V_4H_Em16_S_H :: make_opcode (insn)) ;
                                                    }
                                                }
                                            } else {
                                            ...
                                            if insn & 0x20000000 == 0 {
                                                if insn & 0x40000000 == 0 {
                                                    if insn & 0xffc0f400 == 0xf804000 {
                                                        return Some(
                                                            FMLSL_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                } else {
                                                    if insn & 0xffc0f400 == 0x4f804000 {
                                                        return Some (FMLSL_Vd_V_4S_Vn_V_4H_Em16_S_H :: make_opcode (insn)) ;
                                                    }
                                                }
                                            } else {
                                            ...
                                            if insn & 0x20000000 == 0 {
                                                if insn & 0x40000000 == 0 {
                                                    if insn & 0xff00f400 == 0xf002000 {
                                                        return Some(
                                                            SMLAL_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                } else {
                                                    if insn & 0xff00f400 == 0x4f002000 {
                                                        return Some(
                                                            SMLAL2_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                }
                                            } else {
                                                if insn & 0x40000000 == 0 {
                                                    if insn & 0xff00f400 == 0x2f002000 {
                                                        return Some(
                                                            UMLAL_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                } else {
                                                    if insn & 0xff00f400 == 0x6f002000 {
                                                        return Some(
                                                            UMLAL2_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                }
                                            }
                                            ...
                                            if insn & 0x20000000 == 0 {
                                                if insn & 0x40000000 == 0 {
                                                    if insn & 0xff00f400 == 0xf006000 {
                                                        return Some(
                                                            SMLSL_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                } else {
                                                    if insn & 0xff00f400 == 0x4f006000 {
                                                        return Some(
                                                            SMLSL2_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                }
                                            } else {
                                                if insn & 0x40000000 == 0 {
                                                    if insn & 0xff00f400 == 0x2f006000 {
                                                        return Some(
                                                            UMLSL_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                } else {
                                                    if insn & 0xff00f400 == 0x6f006000 {
                                                        return Some(
                                                            UMLSL2_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                }
                                            }
                                ...
                                if insn & 0x001000 == 0 {
                                    if insn & 0x20000000 == 0 {
                                        ...
                                        if insn & 0xbf80fc00 == 0xf000400 {
                                            return Some(SSHR_Vd_Vn_IMM_VLSR::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0xf002400 {
                                            return Some(SRSHR_Vd_Vn_IMM_VLSR::make_opcode(insn));
                                        }
                                    } else {
                                        ...
                                        if insn & 0xbf80fc00 == 0x2f000400 {
                                            return Some(USHR_Vd_Vn_IMM_VLSR::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0x2f002400 {
                                            return Some(URSHR_Vd_Vn_IMM_VLSR::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0x2f004400 {
                                            return Some(SRI_Vd_Vn_IMM_VLSR::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0x2f006400 {
                                            return Some(SQSHLU_Vd_Vn_IMM_VLSL::make_opcode(insn));
                                        }
                                    }
                                } else {
                                    if insn & 0x20000000 == 0 {
                                        ...
                                        if insn & 0xbf80fc00 == 0xf001400 {
                                            return Some(SSRA_Vd_Vn_IMM_VLSR::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0xf003400 {
                                            return Some(SRSRA_Vd_Vn_IMM_VLSR::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0xf005400 {
                                            return Some(SHL_Vd_Vn_IMM_VLSL::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0xf007400 {
                                            return Some(SQSHL_Vd_Vn_IMM_VLSL::make_opcode(insn));
                                        }
                                    } else {
                                        ...
                                        if insn & 0xbf80fc00 == 0x2f001400 {
                                            return Some(USRA_Vd_Vn_IMM_VLSR::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0x2f003400 {
                                            return Some(URSRA_Vd_Vn_IMM_VLSR::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0x2f005400 {
                                            return Some(SLI_Vd_Vn_IMM_VLSL::make_opcode(insn));
                                        }
                                        if insn & 0xbf80fc00 == 0x2f007400 {
                                            return Some(UQSHL_Vd_Vn_IMM_VLSL::make_opcode(insn));
                                        }
                                    }
                                }
                            }
                                ...
                                if insn & 0x40000000 == 0 {
                                    if insn & 0x200000 == 0 {
                                        if insn & 0xffe08000 == 0x1fc00000 {
                                            return Some(FMADD_Fd_Fn_Fm_Fa::make_opcode(insn));
                                        }
                                        if insn & 0xff208000 == 0x1f000000 {
                                            return Some(
                                                FMADD_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S::make_opcode(
                                                    insn,
                                                ),
                                            );
                                        }
                                        ...
                                        if insn & 0xffe08000 == 0x1fe00000 {
                                            return Some(FNMADD_Fd_Fn_Fm_Fa::make_opcode(insn));
                                        }
                                        if insn & 0xff208000 == 0x1f200000 {
                                            return Some(
                                                FNMADD_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S::make_opcode(
                                                    insn,
                                                ),
                                            );
                                        }
                                        ...
                                        if insn & 0x002000 == 0 {
                                            if insn & 0x004000 == 0 {
                                                if insn & 0x800000 == 0 {
                                                    ...
                                                    if insn & 0xff80f400 == 0x5f801000 {
                                                        return Some(FMLA_Sd_Sn_Em::make_opcode(
                                                            insn,
                                                        ));
                                                    }
                                                }
                                                ...
                                                if insn & 0x800000 == 0 {
                                                    ...
                                                    if insn & 0xff80f400 == 0x5f805000 {
                                                        return Some(FMLS_Sd_Sn_Em::make_opcode(
                                                            insn,
                                                        ));
                                                    }
                                                }
                                            ...
                                            if insn & 0x004000 == 0 {
                                                if insn & 0xff00f400 == 0x5f003000 {
                                                    return Some(SQDMLAL_Sd_Sn_Em16::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            } else {
                                                if insn & 0xff00f400 == 0x5f007000 {
                                                    return Some(SQDMLSL_Sd_Sn_Em16::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            }
                                        ...
                                        if insn & 0x001000 == 0 {
                                            if insn & 0x002000 == 0 {
                                                if insn & 0xff80fc00 == 0x5f000400 {
                                                    return Some(SSHR_Sd_Sn_IMM_VLSR::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            } else {
                                    ...
                                    if insn & 0x002000 == 0 {
                                        if insn & 0x004000 == 0 {
                                            if insn & 0xff80fc00 == 0x7f000400 {
                                                return Some(USHR_Sd_Sn_IMM_VLSR::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        } else {
                                            if insn & 0xff80fc00 == 0x7f004400 {
                                                return Some(SRI_Sd_Sn_IMM_VLSR::make_opcode(insn));
                                            }
                                        }
                                    } else {
                                        if insn & 0x004000 == 0 {
                                            if insn & 0xff80fc00 == 0x7f002400 {
                                                return Some(URSHR_Sd_Sn_IMM_VLSR::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        } else {
                                            if insn & 0xff80fc00 == 0x7f006400 {
                                                return Some(SQSHLU_Sd_Sn_IMM_VLSL::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        }
                                    ...
                                    if insn & 0x002000 == 0 {
                                        if insn & 0x004000 == 0 {
                                            if insn & 0xff80fc00 == 0x7f001400 {
                                                return Some(USRA_Sd_Sn_IMM_VLSR::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        } else {
                                            if insn & 0xff80fc00 == 0x7f005400 {
                                                return Some(SLI_Sd_Sn_IMM_VLSL::make_opcode(insn));
                                            }
                                        }
                                    } else {
                                        if insn & 0x004000 == 0 {
                                            if insn & 0xff80fc00 == 0x7f003400 {
                                                return Some(URSRA_Sd_Sn_IMM_VLSR::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        } else {
                                            if insn & 0xff80fc00 == 0x7f007400 {
                                                return Some(UQSHL_Sd_Sn_IMM_VLSL::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        }
                                            ...
                                            if insn & 0x20000000 == 0 {
                                                ...
                                                if insn & 0x40000000 == 0 {
                                                    if insn & 0xffc0f400 == 0x2f808000 {
                                                        return Some(
                                                            FMLAL2_Vd_Vn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                } else {
                                        ...
                                        if insn & 0x20000000 == 0 {
                                            if insn & 0x40000000 == 0 {
                                                if insn & 0xff80fc00 == 0xf008c00 {
                                                    return Some(
                                                        RSHRN_Vd_Vn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                            } else {
                                                if insn & 0xff80fc00 == 0x4f008c00 {
                                                    return Some(
                                                        RSHRN2_Vd_Vn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                            }
                                        } else {
                                            if insn & 0x40000000 == 0 {
                                                if insn & 0xff80fc00 == 0x2f008c00 {
                                                    return Some(
                                                        SQRSHRUN_Vd_Vn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                            } else {
                                        ...
                                        if insn & 0x002000 == 0 {
                                            if insn & 0x20000000 == 0 {
                                                if insn & 0x40000000 == 0 {
                                                    if insn & 0xff80fc00 == 0xf009c00 {
                                                        return Some(
                                                            SQRSHRN_Vd_Vn_IMM_VLSR::make_opcode(
                                                                insn,
                                                            ),
                                                        );
                                                    }
                                                    ...
                                                    if insn & 0xff80fc00 == 0x4f009c00 {
                                                        return Some(
                                                            SQRSHRN2_Vd_Vn_IMM_VLSR::make_opcode(
                                                                insn,
                                                            ),
                                                        );
                                                    }
                                                ...
                                                if insn & 0x40000000 == 0 {
                                                    if insn & 0xff80fc00 == 0x2f009c00 {
                                                        return Some(
                                                            UQRSHRN_Vd_Vn_IMM_VLSR::make_opcode(
                                                                insn,
                                                            ),
                                                        );
                                                    }
                                                    ...
                                                    if insn & 0xff80fc00 == 0x6f009c00 {
                                                        return Some(
                                                            UQRSHRN2_Vd_Vn_IMM_VLSR::make_opcode(
                                                                insn,
                                                            ),
                                                        );
                                                    }
                                            ...
                                            if insn & 0x20000000 == 0 {
                                                if insn & 0xbff8fc00 == 0xf00fc00 {
                                                    return Some(
                                                        FMOV_Vd_V_4H_SIMD_FPIMM::make_opcode(insn),
                                                    );
                                                }
                                                if insn & 0xbf90fc00 == 0xf10fc00 {
                                                    return Some(
                                                        FCVTZS_Vd_Vn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                                ...
                                                if insn & 0xbf90fc00 == 0x2f10fc00 {
                                                    return Some(
                                                        FCVTZU_Vd_Vn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                ...
                                if insn & 0x40000000 == 0 {
                                    if insn & 0x200000 == 0 {
                                        ...
                                        if insn & 0xff208000 == 0x1f008000 {
                                            return Some(
                                                FMSUB_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S::make_opcode(
                                                    insn,
                                                ),
                                            );
                                        }
                                        ...
                                        if insn & 0xffe08000 == 0x1fe08000 {
                                            return Some(FNMSUB_Fd_Fn_Fm_Fa::make_opcode(insn));
                                        }
                                        if insn & 0xff208000 == 0x1f208000 {
                                            return Some(
                                                FNMSUB_Fd_S_S_Fn_S_S_Fm_S_S_Fa_S_S::make_opcode(
                                                    insn,
                                                ),
                                            );
                                        }
                                                ...
                                                if insn & 0x004000 == 0 {
                                                    if insn & 0x800000 == 0 {
                                                        if insn & 0xffc0f400 == 0x5f009000 {
                                                            return Some(
                                                                FMUL_Sd_Sn_Em16::make_opcode(insn),
                                                            );
                                                        }
                                                    } else {
                                                        if insn & 0xff80f400 == 0x5f809000 {
                                                            return Some(
                                                                FMUL_Sd_Sn_Em::make_opcode(insn),
                                                            );
                                                        }
                                                    }
                                                } else {
                                                    if insn & 0xff00f400 == 0x5f00d000 {
                                                        return Some(
                                                            SQRDMULH_Sd_Sn_Em16::make_opcode(insn),
                                                        );
                                                    }
                                                }
                                            } else {
                                                if insn & 0xff00f400 == 0x5f00b000 {
                                                    return Some(SQDMULL_Sd_Sn_Em16::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            }
                                        ...
                                        if insn & 0x000800 == 0 {
                                            ...
                                            if insn & 0x002000 == 0 {
                                                if insn & 0xff80fc00 == 0x5f009c00 {
                                                    return Some(
                                                        SQRSHRN_Sd_Sn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                            } else {
                                                if insn & 0xff90fc00 == 0x5f10fc00 {
                                                    return Some(
                                                        FCVTZS_Sd_Sn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                                if insn & 0xff80fc00 == 0x5f00fc00 {
                                                    return Some (FCVTZS_Sd_S_S_Sn_S_S_IMM_VLSR_S_S :: make_opcode (insn)) ;
                                                }
                                            }
                                        }
                                    }
                                ...
                                if insn & 0x000400 == 0 {
                                    if insn & 0x002000 == 0 {
                                        if insn & 0x004000 == 0 {
                                            if insn & 0x800000 == 0 {
                                                if insn & 0xffc0f400 == 0x7f009000 {
                                                    return Some(FMULX_Sd_Sn_Em16::make_opcode(
                                                        insn,
                                                    ));
                                                }
                                            } else {
                                        ...
                                        if insn & 0xff00f400 == 0x7f00f000 {
                                            return Some(SQRDMLSH_Sd_Sn_Em16::make_opcode(insn));
                                        }
                                    }
                                } else {
                                    if insn & 0x000800 == 0 {
                                        if insn & 0x001000 == 0 {
                                            if insn & 0x002000 == 0 {
                                                if insn & 0xff80fc00 == 0x7f008400 {
                                                    return Some(
                                                        SQSHRUN_Sd_Sn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                            } else {
                                            ...
                                            if insn & 0xff80fc00 == 0x7f009400 {
                                                return Some(UQSHRN_Sd_Sn_IMM_VLSR::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        }
                                        ...
                                        if insn & 0x001000 == 0 {
                                            if insn & 0xff80fc00 == 0x7f008c00 {
                                                return Some(SQRSHRUN_Sd_Sn_IMM_VLSR::make_opcode(
                                                    insn,
                                                ));
                                            }
                                        } else {
                                            if insn & 0x002000 == 0 {
                                                if insn & 0xff80fc00 == 0x7f009c00 {
                                                    return Some(
                                                        UQRSHRN_Sd_Sn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                            } else {
                                                if insn & 0xff90fc00 == 0x7f10fc00 {
                                                    return Some(
                                                        FCVTZU_Sd_Sn_IMM_VLSR::make_opcode(insn),
                                                    );
                                                }
                                                if insn & 0xff80fc00 == 0x7f00fc00 {
                                                    return Some (FCVTZU_Sd_S_S_Sn_S_S_IMM_VLSR_S_S :: make_opcode (insn)) ;
                                                }
                                            }
                                        }
                                    }
