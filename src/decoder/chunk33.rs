                                        ...
                                        if insn & 0x000400 == 0 {
                                            ...
                                            if insn & 0x000800 == 0 {
                                                if insn & 0xbfe0fc00 == 0xe402400 {
                                                    return Some(FCMEQ_Vd_Vn_Vm::make_opcode(insn));
                                                }
                                            } else {
                                        ...
                                        if insn & 0x004000 == 0 {
                                            if insn & 0x008000 == 0 {
                                                if insn & 0xbf3ffc00 == 0x2e202800 {
                                                    return Some(UADDLP_Vd_Vn::make_opcode(insn));
                                                }
                                            } else {
                                                if insn & 0x010000 == 0 {
                                                    if insn & 0x10000000 == 0 {
                                                ...
                                                if insn & 0x010000 == 0 {
                                                    if insn & 0x080000 == 0 {
                                                        if insn & 0x10000000 == 0 {
                                                            ...
                                                            if insn & 0x20000000 == 0 {
                                                                if insn & 0xffbffc00 == 0x5ea0d800 {
                                                                    return Some (FCMEQ_Sd_Sn_FPIMM0 :: make_opcode (insn)) ;
                                                                }
                                                            } else {
                                                                if insn & 0xffbffc00 == 0x7ea0d800 {
                                        ...
                                        if insn & 0x004000 == 0 {
                                            if insn & 0x008000 == 0 {
                                                if insn & 0xbf3ffc00 == 0x2e303800 {
                                                    return Some(UADDLV_Fd_Vn::make_opcode(insn));
                                                }
                                            } else {
                                                if insn & 0x010000 == 0 {
                                                    if insn & 0x10000000 == 0 {
