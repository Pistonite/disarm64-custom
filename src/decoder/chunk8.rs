...
impl CRC32B_Rd_Rn_Rm {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#crc32b,
            operation: Operation::DP_2SRC(DP_2SRC::CRC32B_Rd_Rn_Rm(CRC32B_Rd_Rn_Rm::from(bits))),
        }
    }
}
...
impl CRC32CB_Rd_Rn_Rm {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#crc32cb,
            operation: Operation::DP_2SRC(DP_2SRC::CRC32CB_Rd_Rn_Rm(CRC32CB_Rd_Rn_Rm::from(bits))),
        }
    }
}
...
impl CRC32CH_Rd_Rn_Rm {
    ...
    pub(crate) fn make_opcode(bits: u32) -> Opcode {
        Opcode {
            mnemonic: Mnemonic::r#crc32ch,
            operation: Operation::DP_2SRC(DP_2SRC::CRC32CH_Rd_Rn_Rm(CRC32CH_Rd_Rn_Rm::from(bits))),
        }
    }
}
